...
function finishQuiz() {
        ...
        if(points < 30) {
            ...
            document.querySelector('.scorePct').style.color = '#006400';
        }

        document.querySelector('.scorePct').innerHTML = `Acertou ${points}%`;
        document.querySelector('.scoreText2').innerHTML = `Você acertou ${questions.length} questões e acertou ${correctAnsewrs}`;
